...
export class TidyUpBalance1533110827233 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_bank_transaction" ("bankTransactionId" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" text NOT NULL, "amount" integer NOT NULL, "description" varchar NOT NULL, "balance" integer, "userNote" varchar NOT NULL, "bankAccountBankAccountId" integer, "categoryCategoryId" integer, "importFileImportFileId" integer, CONSTRAINT "FK_abfdf9d307d0392f9e5ce49816b" FOREIGN KEY ("importFileImportFileId") REFERENCES "import_file" ("importFileId") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_db55b94d4cb02fe2e2f25508ece" FOREIGN KEY ("categoryCategoryId") REFERENCES "category" ("categoryId") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_3383fd03b1fba77bf5aeb9383f4" FOREIGN KEY ("bankAccountBankAccountId") REFERENCES "bank_account" ("bankAccountId") ON DELETE CASCADE ON UPDATE NO ACTION)`);
